...
//----------VARIÁVEIS DOS PONTOS CLICKADOS
//Clique esquerdo
double PX = 0.0;
double PY = 0.0;
//Clique direito
...
void scrInteractor::Init_Menu()
{
	...
	static float btn_color[3] = {0.0f, 0.0f, 0.0f};
